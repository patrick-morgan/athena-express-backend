...
Rules:
1. If you find a new or different "date updated" or "last modified" date, return it in ISO 8601 string (e.g., "2024-09-26T14:30:00Z"). If only the date is available without a specific time, use midnight UTC (e.g., "2024-09-26T00:00:00Z"). If the time zone is specified, convert to UTC. If no time zone is specified, assume it's in the local time of the publication, convert to UTC, and append 'Z' to indicate UTC.
